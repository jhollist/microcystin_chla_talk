...
<img src="hollister_kreakie_fig1.gif" style="width: 80%; height: 80%";></img>
...
ta_perc_child <- 100*sum(nla12$child_cp_exceed==nla12$actual_child_exceed)/nrow(nla12)
fn_perc_child <- 100*sum(nla12$child_cp_exceed == 0 & nla12$actual_child_exceed == 1)/nrow(nla12)
...
- EPA Infant and pre-school children (23 µg/L Chl *a* - 0.3 µg/L Microcystin)
    - Total Accuracy: `r round(ta_perc_child, 0)`%
    - False Negative: `r round(fn_perc_child, 0)`%
- EPA School-age children and adults (84 µg/L Chl *a* -  1.6 µg/L Microcystin)
    - Total Accuracy: `r round(ta_perc_adult, 0)`%
    - False Negative: `r round(fn_perc_adult, 0)`%
...
```{r echo=FALSE} 
df <- conmat_to_df(table(nla12$adult_cp_exceed, nla12$actual_adult_exceed)) #%>%
...
- Not a replacment for toxins
- Concentration to target is a managment decision
- National data
  - Local/Regional variation obscured
